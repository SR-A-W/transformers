#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/src/transformers/models/qwen2_pl_moe/modular_qwen2_pl_moe.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_qwen2_pl_moe.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class Qwen2PlMoeExpertMLP(nn.Module):
...
class Qwen2PlMoeAttention(nn.Module):
...
class Qwen2PlMoeRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        Qwen2PlMoeRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Qwen2PlMoeDecoderLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config: Qwen2PlMoeConfig, layer_idx: int):
        ...
        self.self_attn = Qwen2PlMoeAttention(config=config, layer_idx=layer_idx)
        self.mlp = Qwen2PlMoeMLP(config)
        self.input_layernorm = Qwen2PlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = Qwen2PlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
@auto_docstring
class Qwen2PlMoePreTrainedModel(PreTrainedModel):
    config: Qwen2PlMoeConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Qwen2PlMoeDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": Qwen2PlMoeDecoderLayer,
        "attentions": Qwen2PlMoeAttention,
    }


class Qwen2PlMoeRotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: Qwen2PlMoeConfig, device=None):
        super().__init__()
...
@auto_docstring
class Qwen2PlMoeModel(Qwen2PlMoePreTrainedModel):
    ...
    def __init__(self, config: Qwen2PlMoeConfig):
        ...
        self.norm = Qwen2PlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = Qwen2PlMoeRotaryEmbedding(config=config)
...
@auto_docstring
class Qwen2PlMoeForCausalLM(Qwen2PlMoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Qwen2PlMoeForCausalLM

        >>> model = Qwen2PlMoeForCausalLM.from_pretrained("meta-qwen2_pl_moe/Qwen2PlMoe-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-qwen2_pl_moe/Qwen2PlMoe-2-7b-hf")
