#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/src/transformers/models/phi4_mini_pl_moe/modular_phi4_mini_pl_moe.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_phi4_mini_pl_moe.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
from ...utils import FlashAttentionKwargs, TransformersKwargs, auto_docstring, can_return_tuple
from ...utils.generic import check_model_inputs
from .configuration_phi4_mini_pl_moe import Phi4MiniPlMoeConfig


class Phi4MiniPlMoeExpertMLP(nn.Module):
...
class Phi4MiniPlMoeAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: Phi4MiniPlMoeConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Phi4MiniPlMoeRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        Phi4MiniPlMoeRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Phi4MiniPlMoeDecoderLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config: Phi4MiniPlMoeConfig, layer_idx: int):
        ...
        self.self_attn = Phi4MiniPlMoeAttention(config=config, layer_idx=layer_idx)
        # 将父类创建的 Phi3MLP 替换为 PL-MoE 双专家容器
        self.mlp = Phi4MiniPlMoeMLP(config)
        self.input_layernorm = Phi4MiniPlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = Phi4MiniPlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.config = config
...
@auto_docstring
class Phi4MiniPlMoePreTrainedModel(PreTrainedModel):
    config: Phi4MiniPlMoeConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Phi4MiniPlMoeDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": Phi4MiniPlMoeDecoderLayer,
        "attentions": Phi4MiniPlMoeAttention,
    }
    _version = "0.0.5"


class Phi4MiniPlMoeRotaryEmbedding(nn.Module):
    def __init__(self, config: Phi4MiniPlMoeConfig, device=None):
        super().__init__()
...
@auto_docstring
class Phi4MiniPlMoeModel(Phi4MiniPlMoePreTrainedModel):
    ...
    def __init__(self, config: Phi4MiniPlMoeConfig):
        ...
        self.norm = Phi4MiniPlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = Phi4MiniPlMoeRotaryEmbedding(config=config)
...
@auto_docstring
class Phi4MiniPlMoeForCausalLM(Phi4MiniPlMoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Phi4MiniPlMoeForCausalLM

        >>> model = Phi4MiniPlMoeForCausalLM.from_pretrained("meta-phi4_mini_pl_moe/Phi4MiniPlMoe-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-phi4_mini_pl_moe/Phi4MiniPlMoe-2-7b-hf")
