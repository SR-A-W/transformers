#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/src/transformers/models/llama_pl_moe/modular_llama_pl_moe.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_llama_pl_moe.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class LlamaPlMoeExpertMLP(nn.Module):
...
class LlamaPlMoeRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        LlamaPlMoeRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class LlamaPlMoeAttention(nn.Module):
...
class LlamaPlMoeDecoderLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config: LlamaPlMoeConfig, layer_idx: int):
        ...
        self.self_attn = LlamaPlMoeAttention(config=config, layer_idx=layer_idx)
        # 将父类创建的 LlamaMLP 替换为 PL-MoE 双专家容器
        self.mlp = LlamaPlMoeMLP(config)
        self.input_layernorm = LlamaPlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = LlamaPlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
class LlamaPlMoeRotaryEmbedding(nn.Module):
    def __init__(self, config: LlamaPlMoeConfig, device=None):
        super().__init__()
...
@auto_docstring
class LlamaPlMoePreTrainedModel(PreTrainedModel):
    config: LlamaPlMoeConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["LlamaPlMoeDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": LlamaPlMoeDecoderLayer,
        "attentions": LlamaPlMoeAttention,
    }
...
@auto_docstring
class LlamaPlMoeModel(LlamaPlMoePreTrainedModel):
    ...
    def __init__(self, config: LlamaPlMoeConfig):
        ...
        self.norm = LlamaPlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = LlamaPlMoeRotaryEmbedding(config=config)
...
@auto_docstring
class LlamaPlMoeForCausalLM(LlamaPlMoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, LlamaPlMoeForCausalLM

        >>> model = LlamaPlMoeForCausalLM.from_pretrained("meta-llama_pl_moe/LlamaPlMoe-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-llama_pl_moe/LlamaPlMoe-2-7b-hf")
