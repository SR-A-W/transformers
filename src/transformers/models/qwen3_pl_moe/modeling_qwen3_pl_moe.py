#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/src/transformers/models/qwen3_pl_moe/modular_qwen3_pl_moe.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_qwen3_pl_moe.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
class Qwen3PlMoeExpertMLP(nn.Module):
...
class Qwen3PlMoeRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        Qwen3PlMoeRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class Qwen3PlMoeAttention(nn.Module):
    ...
    def __init__(self, config: Qwen3PlMoeConfig, layer_idx: int):
        ...
        self.q_norm = Qwen3PlMoeRMSNorm(self.head_dim, eps=config.rms_norm_eps)  # unlike olmo, only on the head dim!
        self.k_norm = Qwen3PlMoeRMSNorm(
...
class Qwen3PlMoeDecoderLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config: Qwen3PlMoeConfig, layer_idx: int):
        ...
        self.self_attn = Qwen3PlMoeAttention(config=config, layer_idx=layer_idx)
        # 将父类创建的 Qwen3MLP 替换为 PL-MoE 双专家容器
        self.mlp = Qwen3PlMoeMLP(config)
        self.input_layernorm = Qwen3PlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.post_attention_layernorm = Qwen3PlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
...
@auto_docstring
class Qwen3PlMoePreTrainedModel(PreTrainedModel):
    config: Qwen3PlMoeConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Qwen3PlMoeDecoderLayer"]
    ...
    _can_record_outputs = {
        "hidden_states": Qwen3PlMoeDecoderLayer,
        "attentions": Qwen3PlMoeAttention,
    }


class Qwen3PlMoeRotaryEmbedding(nn.Module):
    def __init__(self, config: Qwen3PlMoeConfig, device=None):
        super().__init__()
...
@auto_docstring
class Qwen3PlMoeModel(Qwen3PlMoePreTrainedModel):
    ...
    def __init__(self, config: Qwen3PlMoeConfig):
        ...
        self.norm = Qwen3PlMoeRMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = Qwen3PlMoeRotaryEmbedding(config=config)
...
@auto_docstring
class Qwen3PlMoeForCausalLM(Qwen3PlMoePreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, Qwen3PlMoeForCausalLM

        >>> model = Qwen3PlMoeForCausalLM.from_pretrained("Qwen/Qwen3PlMoe-8B")
        >>> tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen3PlMoe-8B")
